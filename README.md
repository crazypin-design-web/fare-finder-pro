...
Hero section: product name "Target Flight Price Notifier" prominently displayed, value prop 「只要設定航線與目標價，達標馬上通知你」 (English subtitle: "Once set a route and a target price — we email you when the fare drops."), and a primary CTA button labeled "Sign in / 登入" in the top-right header.
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/80da6c64-42db-4f4b-b915-4c3c20301f0c).
